...
figlet "Tools"
echo $w"———————————————————————————————————————————"
echo $cy" Author"$r"  : "$cy"Radhin Al Haady "
echo $cy" YouTube"$r" : "$cy"no YouTube account "
echo $cy" Team"$r"    : "$cy"anonymous indonesia"
echo $w"———————————————————————————————————————————"
	sleep 3
echo
echo
...
echo
echo $w"———————————————————————————————"
echo $p" Tools Attack [}masih dalam tahap pengembangan{]: "
...
echo $w"————————————————————————————————"
echo
echo $w"["$r"00"$w"] "$r"EXIT_-asem kau nih"
echo
echo $w"————————————————————————————————"
read -p " [?] Pilih : " pil;
# batas gan
...
cd Planetwork-DDOS
python2 pntddos.py
echo "setelah kalian install ketikkan 'python2 pntddos.py ip port packet. Contoh : python2 pntddos.py 23.215.130.10 80 135' lalu klik 'enter'"
fi
#batas gan
if [ $pil = 12 ] || [ $pil = 12 ]
then
